...
There really isn't much to draw here. We could make it fancy and add all kinds of crazy table graphics, but for now, let's keep it simple and just make a dotted line for the net.

We could create a single image for the entire net, but that would waste program space. Instead, we'll use an image of the dot, and copy it over and over until it makes a line.
